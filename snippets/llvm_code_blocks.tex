...
\begin{code}
    \centering
    \captionof{lstlisting}{LLVM's intermediate representation program, its extracted code blocks and replacement candidates. Gray highlighted lines represent original code block, green for candidate code replacements. }\label{example:crow:original:llvm}
    \lstset{numbers=none}
    ...
    ?\tikzmarkWS{2}{code block 2}{11.5}{10}{3.5cm}?
    ?\tikzmarkWS{1}{code block 1}{11.5}{3.5}{3.0cm}?
    %2 = mul nsw i32 %0,2
    %3 = add nsw i32 %0,%2 
    ...
    \begin{minipage}[t]{.32\linewidth}
        \begin{lstlisting}[xleftmargin=1em,escapechar=?]
?Replacement candidates for code\_block\_1?
...
?Replacement candidates for code\_block\_2?
