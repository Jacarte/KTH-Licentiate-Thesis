...
We produce at least one unique \termidx{program variant }for $239/303{}$ single function programs for \corpusrosetta with one hour for a diversification timeout. For the rest of the programs ($64/303{}$), the timeout is reached before \termidx{CROW }can find any valid variant. 
