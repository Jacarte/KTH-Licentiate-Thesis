...
This chapter discusses the technical details for the tools implemented for our main contributions.
...
In \autoref{chapter:method} we discuss the methodology we follow to evaluate how CROW and MEWE creates software diversification.