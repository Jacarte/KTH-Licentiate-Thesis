...
\begin{figure*}[h]
    ...
    \caption{CROW workflow to generate program variants following \step{3} in \autoref{diagrams:generic}. CROW takes LLVM bitcodes to look for functionally equivalent code replacements and generates program variants by combining them.}
    \label{diagrams:crow}
\end{figure*}
