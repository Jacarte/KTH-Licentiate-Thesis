...
\titleformat{\chapter}[display]
  {\LARGE}
  {\renewcommand{\thechapter}{{\color{gray}0}\arabic{chapter}\color{gray}\vspace{2.0ex}\titlerule}\hspace*{-1.5em}
  %\colorbox{blacm}
  ...
  \vspace{-10.2ex}\filleft\parbox[t]{0.5\textwidth}{\begin{flushright}\MakeUppercase{#1}\\\end{flushright}}\hspace*{2em}}
  [\vspace{1ex}]
